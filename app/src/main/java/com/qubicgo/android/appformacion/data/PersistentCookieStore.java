package com.qubicgo.android.appformacion.data;
...
public class PersistentCookieStore implements CookieStore {
    ...
    private static URI cookieUri(URI uri, HttpCookie cookie) {
        ...
        if (cookie.getDomain() != null) {
            ...
            try {
                cookieUri = new URI(uri.getScheme() == null ?
                        "http" :
                        uri.getScheme(), domain, cookie.getPath() == null ? "/" : cookie.getPath(), null);
