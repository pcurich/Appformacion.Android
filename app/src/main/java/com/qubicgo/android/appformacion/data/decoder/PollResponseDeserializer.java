...
public class PollResponseDeserializer  implements JsonDeserializer<PollResponse> {
    @Override
    public PollResponse deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        return new PollResponse(message,status,isError);
    }
}
