...
public class TextViewJustifiedCustom extends TextViewCustom implements Justify.Justified {
    @SuppressWarnings("unused")
    public TextViewJustifiedCustom(final @NotNull Context context) {
        super(context);
        super.setMovementMethod(new LinkMovementMethod());
    }

    @SuppressWarnings("unused")
    public TextViewJustifiedCustom(final @NotNull Context context, final AttributeSet attrs) {
        super(context, attrs);
